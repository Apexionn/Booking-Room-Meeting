...
// Autocomplete
    Route::get('/autocomplete-search-room',[RoomController::class,'search'])->name('autocomplete-rooms');
    Route::get('/autocomplete-search-booking',[BookingController::class,'search'])->name('autocomplete-booking');
    Route::get('/autocomplete-search-user',[UserController::class,'search'])->name('autocomplete-users');
