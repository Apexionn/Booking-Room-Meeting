...
<body>
    <div class="logo">
        <a href="/rooms"><img src="<?php echo e(asset('IMG/logo.png')); ?>"></a>
    </div>
    <ul>
        <li>
            <div class="popover">
    ...
    <div class="form">
        ...
        <h2 class="heading2"><?php echo e($roomData->name); ?></h2>
        <br>
        <form action="/update-room/<?php echo e($id); ?>" method="POST" enctype="multipart/form-data" id="roomForm">
            <?php echo csrf_field(); ?>
        <label for="name" class="add1">Name :
            <input class="form-control" type="text" name="name" id="name" value="<?php echo e($roomData->name); ?>">
        </label>
        <br>
        <label for="image" class="add1">Change Image :
            <input class="form-control" type="file" name="image" id="image" value="<?php echo e($roomData->image); ?>">
        </label>
        <br>
        <p class="add1">Current Image : </p>
        <img class="picture" src="<?php echo e(asset('images/'.$roomData->image)); ?>" alt="" style="width: 80px">
        <span class="picture-text" name="old" value="<?php echo e($roomData->image); ?>" hidden><?php echo e($roomData->image); ?></span>
        <input type="hidden" value="<?php echo e($roomData->image); ?>" name="old">
        <br> <br>
        ...
        <div class="duo-button">
            ...
            <button style="color: #fff;" type="submit" name="submit">Update</button>
        </div>
        </form>
    </div>
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/admin/rooms/updateRoom.blade.php ENDPATH**/ ?>