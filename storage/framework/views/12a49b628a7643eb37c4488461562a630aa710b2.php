        ...
        <tbody>
            ...
            <tr class="table-row <?php echo e($no % 2 == 0 ? 'even-row' : 'odd-row'); ?>">
                    ...
                    <td>
                        <?php
                        ?>
                        <img class="foto" src="<?php echo e(asset('images/'.$room->image)); ?>" alt="" style="width: 80px">
                    </td>
                    <td scope="row">
                        <div class="tes">
                            <a href="/select-room/<?php echo e($room->id); ?>" class="edit">Edit</a>
                            <a href="/delete-room/<?php echo e($room->id); ?>" class="delete">Delete</a>
                        </div>
                    </td>
                </tr>
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/admin/rooms/dashboard.blade.php ENDPATH**/ ?>