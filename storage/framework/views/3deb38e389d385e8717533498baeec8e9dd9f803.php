...
<div class="bgenam">
    ...
    <div class="form">
        ...
        <br>
        <form action="/insert-room-data" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/admin/rooms/createRoom.blade.php ENDPATH**/ ?>