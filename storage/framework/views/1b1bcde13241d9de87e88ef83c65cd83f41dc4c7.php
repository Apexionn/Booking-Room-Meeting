...
<div class="form">
    ...
    <h2 class="heading2">New Room</h2>

    <label class="add1">Room Name</label>
    <label class="add2">Picture</label><br>

    <input type="text" name="name" id="name" placeholder="Enter the Room Name" required>
    <input type="file" name="image" id="image" required>

        
        <br>
        <button class="batal" onclick="window.location = 'admin'"><a href="admin" style="text-decoration: none; color: white;">Cancel</a></button>
        <button type="submit" name="submit" style="color: #fff;">Add</button>
    </form>
</div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/admin/create.blade.php ENDPATH**/ ?>