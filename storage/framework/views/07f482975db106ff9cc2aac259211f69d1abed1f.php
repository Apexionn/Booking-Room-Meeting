...
<head>
	...
	<title>Home</title>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('CSS/stylecalendar.css')); ?>">
</head>
<body>
	<div class="logo">
            ...
            <div class="popover">
                <ul>
                    <li>
                        ...
                        <div class="content">
                            <a href="<?php echo e(route('employee.account', ['id' => auth()->user()->id])); ?>" class="acc">My Account</a>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                dateClick: function(info) {
                    ...
                    var userId = <?php echo e(auth()->user()->id); ?>; // Get the user ID of the logged-in user
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/employee/home.blade.php ENDPATH**/ ?>