...
<body>
    <div class="logo">
        <a href="/bookings"><img src="<?php echo e(asset('IMG/logo.png')); ?>"></a>
    </div>
    <ul>
        <li>
            <div class="popover">
...
<script type="text/javascript">
    var route = "<?php echo e(route('autocomplete-booking')); ?>";
    $('#search').typeahead({
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <?php if($booking->status == 0): ?>
                ...
                ?>
        <td><?php echo e($no++); ?></td>
        <td><?php echo e($roomName); ?></td>
        <td><?php echo e($booking->name); ?></td>
        <td><?php echo e($booking->description); ?></td>
        <td><?php echo e($booking->booking_date); ?></td>
        <td><?php echo e($booking->time_start); ?>-<?php echo e($booking->time_end); ?></td>
        <td>
            <div class="tes">
                    <a class="delete" href="/reject-form/<?php echo e($booking->id); ?>">Reject</a>
            </div>
        </td>
        <?php endif; ?>
    </tr>
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/admin/bookings/dashboard.blade.php ENDPATH**/ ?>