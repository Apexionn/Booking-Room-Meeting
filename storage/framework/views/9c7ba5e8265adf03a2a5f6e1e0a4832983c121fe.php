...
<body>
    ...
    <ul>
        <li><a href="<?php echo e(route('login')); ?>"><div class="user"> <img src="<?php echo e(asset('IMG/user.png')); ?>"></div></a></li>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                dateClick: function(info) {
                    ...
                    window.location.href = '<?php echo e(route("login")); ?>?clickedDate=' + clickedDate;
                },
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/dashboard.blade.php ENDPATH**/ ?>