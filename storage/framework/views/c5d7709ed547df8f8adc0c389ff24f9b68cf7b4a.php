...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset("CSS/NEWstyleadmin.css")); ?>">
</head>
<body>
    <div class="logo">
        <a href="/admin"><img src="<?php echo e(asset('IMG/logo.png')); ?>"></a>
    </div>
    <ul>
        <li>
            <div class="popover">
...
<div class="bgdua"><svg xmlns="http://www.w3.org/2000/svg" width="133" height="156" viewBox="0 0 133 156" fill="none">
...
<div class="bgempat"><svg xmlns="http://www.w3.org/2000/svg" width="219" height="473" viewBox="0 0 219 473" fill="none">
...
<div class="bgenam"><svg xmlns="http://www.w3.org/2000/svg" width="111" height="116" viewBox="0 0 111 116" fill="none">
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/admin/index.blade.php ENDPATH**/ ?>