...
<body>
    ...
    <div class="container-search autocomplete-container">
        <form class="search-form" role="search" action="/rooms">
            <input class="typeahead form-control" type="search" placeholder="Search..." aria-label="Search" name="search" id="search">
...
<div class="table-container">
    <table class="table">
        ...
        <tbody>
            ...
            <tr class="table-row <?php echo e($no % 2 == 0 ? 'even-row' : 'odd-row'); ?>">
                    <td><?php echo e($no++); ?></td>
                    ...
                    <td>
                        <?php
                        ?>
                        <img class="fotopfp" src="<?php echo e(asset('images/'.$user->image)); ?>" alt="" style="width: 80px">
                    </td>
                    <td scope="row">
                        <div class="tes">
                                <a href="/select-user/<?php echo e($user->id); ?>" class="edit">Edit</a>
                                <a href="/delete-user/<?php echo e($user->id); ?>" class="delete">Delete</a>
                        </div>
                    </td>
                </tr>
    ...
    <br>
    <button class="btn btn-primary" onclick="window.location = 'create-user'">
        <a href="create-user" class="text-decoration-none text-light">ADD Data</a>
    </button>
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/admin/employees/dashboard.blade.php ENDPATH**/ ?>