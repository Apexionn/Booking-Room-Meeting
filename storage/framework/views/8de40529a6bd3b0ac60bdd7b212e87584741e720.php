...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('CSS/rejectform.css')); ?>">
    <title>Rejection Form</title>
</head>
<body>
    <div class="form">
        <h2 class="heading1">Reject Booking <?php echo e($booking->users[0]->name); ?></h2>
        <br>
            <form action="/reject-booking/<?php echo e($id); ?>" method="">
                <?php echo csrf_field(); ?>
                <div class="add1">
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/admin/bookings/reject-form.blade.php ENDPATH**/ ?>