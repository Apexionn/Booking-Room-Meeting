...
<body>
    ...
    <ul>
        <li>
            <div class="popover">
                <ul>
                    <li>
                        <a href=""><img class="user" src="<?php echo e(asset('images/'.$user->image)); ?>"></a>
                        <div class="content">
                            <a href=" " class="acc">My Account</a>
                            <a href="<?php echo e(route('Allbookings', ['id' => auth()->user()->id])); ?>" class="bookings">My Bookings</a>
    ...
    <div class="container">
        <div class="left-column">
            <form action="<?php echo e(route('update-profile-image', ['id' => auth()->user()->id])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <label for="photo">
                    <div class="pfp-container">
                        <img class="pfp" src="<?php echo e(asset('images/'.$user->image)); ?>" id="profile-image">
                    </div>
                </label>
        ...
        <div class="right-column">
            ...
            <input type="text" name="name" value="<?php echo e($user->name); ?>" readonly><br>

            <label class="add2">City &nbsp &nbsp &nbsp &nbsp:   &nbsp</label>
            <input type="text" name="city" value="<?php echo e($user->division); ?>" readonly><br>

            <label class="add3">E-mail &nbsp:   &nbsp</label>
            <input type="email" name="mail" value="<?php echo e($user->email); ?>" readonly>
...
<?php /**PATH /Users/lintang/Documents/laravel/bookingmeetingroomV2/resources/views/employee/account.blade.php ENDPATH**/ ?>